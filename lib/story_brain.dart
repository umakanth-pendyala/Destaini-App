...
class StoryBrain {
  ...
  String getStory() {
    return _storyData[storyNumber].myTitle;
  }

  String getChoice_1() {
    return _storyData[storyNumber].choice_1;
  }

  String getChoice_2() {
    return _storyData[storyNumber].choice_2;
  }
  ...
  bool buttonsShouldBeVisible() {
    if (storyNumber >= 0 && storyNumber <= 2) return true;
    return false;
  }
